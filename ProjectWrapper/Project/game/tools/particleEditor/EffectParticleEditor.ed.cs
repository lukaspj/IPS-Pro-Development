...
{   
   ...
   if( %bitmap !$= "" )
   {
      PEP_EffectParticleEditor-->PEP_previewImage.setBitmap( %bitmap );
      PEP_EffectParticleEditor-->PEP_previewImageName.setText( %bitmap );
      PEP_EffectParticleEditor-->PEP_previewImageName.tooltip = %bitmap;
   }
   else
   {
      PEP_EffectParticleEditor-->PEP_previewImage.setBitmap( "" );
      PEP_EffectParticleEditor-->PEP_previewImageName.setText( "None" );
      PEP_EffectParticleEditor-->PEP_previewImageName.tooltip = "None";
   }
   
   PEP_EffectParticleEditor-->PEP_inverseAlpha.setValue( %data.useInvAlpha );
   ...
   PEP_EffectParticleEditor-->PEP_spinRandomMin_slider.setValue( %data.spinRandomMin );
   PEP_EffectParticleEditor-->PEP_spinRandomMin_textEdit.setText( %data.spinRandomMin );
   
   PEP_EffectParticleEditor-->PEP_spinRandomMax_slider.setValue( %data.spinRandomMax );
   PEP_EffectParticleEditor-->PEP_spinRandomMax_textEdit.setText( %data.spinRandomMax  );
   
   PEP_EffectParticleEditor-->PEP_spinRandomMax_slider.setValue( %data.spinRandomMax );
   PEP_EffectParticleEditor-->PEP_spinRandomMax_textEdit.setText( %data.spinRandomMax  );
   
   PEP_EffectParticleEditor-->PEP_spinSpeed_slider.setValue( %data.spinSpeed );
   PEP_EffectParticleEditor-->PEP_spinSpeed_textEdit.setText( %data.spinSpeed );
   ...
   PEP_EffectParticleEditor-->PEP_pointSize_slider0.setValue( %data.sizes[ 0 ] );
   PEP_EffectParticleEditor-->PEP_pointSize_textEdit0.setText( %data.sizes[ 0 ] );
   
   PEP_EffectParticleEditor-->PEP_pointSize_slider1.setValue( %data.sizes[ 1 ] );
   PEP_EffectParticleEditor-->PEP_pointSize_textEdit1.setText( %data.sizes[ 1 ] );
   
   PEP_EffectParticleEditor-->PEP_pointSize_slider2.setValue( %data.sizes[ 2 ] );
   PEP_EffectParticleEditor-->PEP_pointSize_textEdit2.setText( %data.sizes[ 2 ] );
   
   PEP_EffectParticleEditor-->PEP_pointSize_slider3.setValue( %data.sizes[ 3 ] );
   PEP_EffectParticleEditor-->PEP_pointSize_textEdit3.setText( %data.sizes[ 3 ] );
