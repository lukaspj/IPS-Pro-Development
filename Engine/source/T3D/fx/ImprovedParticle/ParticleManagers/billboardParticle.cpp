...
IMPLEMENT_CO_DATABLOCK_V1(BillboardParticleData);

ConsoleDocClass( BillboardParticleData,
...
// Constructor
//-----------------------------------------------------------------------------
BillboardParticleData::BillboardParticleData()
{
...
// initPersistFields
//-----------------------------------------------------------------------------
void BillboardParticleData::initPersistFields()
{
...
// Pack data
//-----------------------------------------------------------------------------
void BillboardParticleData::packData(BitStream* stream)
{
...
// Unpack data
//-----------------------------------------------------------------------------
void BillboardParticleData::unpackData(BitStream* stream)
{
...
bool BillboardParticleData::protectedSetTimes( void *object, const char *index, const char *data) 
{
   BillboardParticleData *pData = static_cast<BillboardParticleData*>( object );
   F32 val = dAtof(data);
   U32 i;
...
// onAdd
//-----------------------------------------------------------------------------
bool BillboardParticleData::onAdd()
{
...
// preload
//-----------------------------------------------------------------------------
bool BillboardParticleData::preload(bool server, String &errorStr)
{
...
bool BillboardParticleData::reload(char errorBuffer[256])
{
...
void BillboardParticleData::preloadVector(Vector<ParticleData*> _particleDataBlocks, U32 mask, ParticleEmitterData* emitterData)
{
   if(mask & ParticleVectorPreloadFlags::ParticleTextures)
   {
      BillboardParticleData* particleDataBlock = static_cast<BillboardParticleData*>(_particleDataBlocks[0]);
      ...
      {
         particleDataBlock = static_cast<BillboardParticleData*>(_particleDataBlocks[i]);
...
DefineEngineMethod(BillboardParticleData, reload, void, (),,
