...
#ifndef POINTLIGHT_PARTICLE_MANAGER_H_
#define POINTLIGHT_PARTICLE_MANAGER_H_

#include "particleManager.h"

class PointLightParticleManager : public ParticleManager
{
public:
   PointLightParticleManager();
   ~PointLightParticleManager();
...
#endif // POINTLIGHT_PARTICLE_MANAGER_H_
