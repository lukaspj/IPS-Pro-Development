...
#ifndef EMITTER_PARTICLE_MANAGER_H_
#define EMITTER_PARTICLE_MANAGER_H_

#include "particleManager.h"

class EmitterParticleManager : public ParticleManager
{
public:
   EmitterParticleManager();
   ~EmitterParticleManager();
...
#endif // EMITTER_PARTICLE_MANAGER_H_
