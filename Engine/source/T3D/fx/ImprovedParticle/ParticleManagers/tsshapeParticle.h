...
#ifndef TSSHAPE_PARTICLE_H_
#define TSSHAPE_PARTICLE_H_
...
class TSShapeParticleData : public ParticleData
{
...
public:
   ...
   virtual TSShapeParticleManager* CreateManager() { return new TSShapeParticleManager; };
   ...
   // Declares -----
   DECLARE_CONOBJECT(TSShapeParticleData);
};

struct TSShapeParticle : Particle
{
   TSShapeInstance* shape;
};


#endif // TSSHAPE_PARTICLE_H_
