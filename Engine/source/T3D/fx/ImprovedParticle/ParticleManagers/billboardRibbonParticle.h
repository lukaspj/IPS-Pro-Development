...
#ifndef BILLBOARD_RIBBON_PARTICLE_H_
#define BILLBOARD_RIBBON_PARTICLE_H_
...
class BillboardRibbonParticleData : public ParticleData
{
   typedef ParticleData Parent;
public:
   BillboardRibbonParticleData();
   ~BillboardRibbonParticleData();
   ...
   virtual BillboardRibbonParticleManager* CreateManager() { return new BillboardRibbonParticleManager; };

   DECLARE_CONOBJECT(BillboardRibbonParticleData);
};

struct BillboardRibbonParticle : Particle
{
public:
...
#endif // BILLBOARD_RIBBON_PARTICLE_H_
