...
#ifndef EFFECT_PARTICLE_H_
#define EFFECT_PARTICLE_H_
...
#include "T3D\fx\ImprovedParticle\particleEffect.h"

class EffectParticleData : public ParticleData
{
...
public:
   ...
   virtual EffectParticleManager* CreateManager() { return new EffectParticleManager; };

   // Fields -----
   ParticleEffectData* mEffectData;

   // Declares -----
   DECLARE_CONOBJECT(EffectParticleData);
};
