...
#ifndef EMITTER_PARTICLE_H_
#define EMITTER_PARTICLE_H_
...
class EmitterParticleData : public ParticleData
{
...
public:
   ...
   virtual EmitterParticleManager* CreateManager() { return new EmitterParticleManager; };

   // Fields -----
   ParticleEmitterData* mEmitterData;

   // Declares -----
   DECLARE_CONOBJECT(EmitterParticleData);
};
