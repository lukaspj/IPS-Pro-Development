...
#ifndef BILLBOARD_PARTICLE_MANAGER_H_
#define BILLBOARD_PARTICLE_MANAGER_H_

#include "particleManager.h"

class BillboardParticleManager : public ParticleManager
{
	...
	inline void setupAligned( Particle *part, 
		const ColorF &ambientColor,
		ParticleVertexType *lVerts );

public:
   BillboardParticleManager();
   ~BillboardParticleManager();
...
#endif // BILLBOARD_PARTICLE_MANAGER_H_
