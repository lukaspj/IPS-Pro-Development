...
#ifndef TSSHAPE_PARTICLE_MANAGER_H_
#define TSSHAPE_PARTICLE_MANAGER_H_

#include "particleManager.h"

class TSShapeParticleManager : public ParticleManager
{
public:
   TSShapeParticleManager();
   ~TSShapeParticleManager();
   ...
   void RenderParticle( SceneRenderState* state, Particle* part );
};

#endif // TSSHAPE_PARTICLE_MANAGER_H_
