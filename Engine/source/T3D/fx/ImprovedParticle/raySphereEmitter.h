...
#ifndef RAYSPHERE_EMITTER_H_
#define RAYSPHERE_EMITTER_H_

#include "T3D\fx\particleEmitter.h"

class RaySphereEmitterData : public ParticleEmitterData
{
	typedef ParticleEmitterData Parent;

public:
	RaySphereEmitterData();
	DECLARE_CONOBJECT(RaySphereEmitterData);
...
class RaySphereEmitter : public ParticleEmitter
{
...
public:
	...
	DECLARE_CONOBJECT(RaySphereEmitter);
...
private:
	virtual RaySphereEmitterData* getDataBlock() { return static_cast<RaySphereEmitterData*>(Parent::getDataBlock()); }
