...
#if TORQUE_GAME_ENGINE < 3500
   Frustum cullingFrustrum = state->getCullingState().getFrustum();
#else
   Frustum cullingFrustrum = state->getCullingState().getCullingFrustum();
#endif
   if(SB && !cullingFrustrum.isCulled(mObjBox))
