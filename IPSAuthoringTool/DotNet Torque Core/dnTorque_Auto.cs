...
internal void fnArrayObject_sort (string arrayobject, bool descending)
{
var sbarrayobject = new StringBuilder(arrayobject, 1024);

SafeNativeMethods.mwle_fnArrayObject_sort(sbarrayobject, descending);
}
/// <summary>
...
internal void fnArrayObject_sortk (string arrayobject, bool descending)
{
var sbarrayobject = new StringBuilder(arrayobject, 1024);

SafeNativeMethods.mwle_fnArrayObject_sortk(sbarrayobject, descending);
}
/// <summary>
...
internal void fnArrayObject_sortn (string arrayobject, bool descending)
{
var sbarrayobject = new StringBuilder(arrayobject, 1024);

SafeNativeMethods.mwle_fnArrayObject_sortn(sbarrayobject, descending);
}
/// <summary>
...
internal void fnArrayObject_sortnk (string arrayobject, bool descending)
{
var sbarrayobject = new StringBuilder(arrayobject, 1024);

SafeNativeMethods.mwle_fnArrayObject_sortnk(sbarrayobject, descending);
}
/// <summary>
...
internal string fn__getSpecificDatablocks (string a1)
{
var returnbuff = new StringBuilder(4096);
var sba1 = new StringBuilder(a1, 4096);

SafeNativeMethods.mwle_fn__getSpecificDatablocks(sba1, returnbuff);
return returnbuff.ToString();
...
internal void fn_DumpIPSBenchmark ()
{

SafeNativeMethods.mwle_fn_DumpIPSBenchmark();
}
/// <summary>
/// Reloads the ParticleData datablocks and other fields used by this emitter.
/// 	@tsexample
...
internal void fnMeshEmitterData_reload (string meshemitterdata)
{
var sbmeshemitterdata = new StringBuilder(meshemitterdata, 1024);

SafeNativeMethods.mwle_fnMeshEmitterData_reload(sbmeshemitterdata);
}
/// <summary>
/// )
/// 
...
internal void fn_ParticleEffect_umpEmitters (string particleeffect)
{
var sbparticleeffect = new StringBuilder(particleeffect, 1024);

SafeNativeMethods.mwle_fn_ParticleEffect_umpEmitters(sbparticleeffect);
}
/// <summary>
/// )
/// 
...
internal void fn_ParticleEffect_eset (string particleeffect)
{
var sbparticleeffect = new StringBuilder(particleeffect, 1024);

SafeNativeMethods.mwle_fn_ParticleEffect_eset(sbparticleeffect);
}
/// <summary>
/// Reloads the ParticleData datablocks and other fields used by this emitter.
/// 	@tsexample
...
internal void fnRadiusMeshEmitterData_reload (string radiusmeshemitterdata)
{
var sbradiusmeshemitterdata = new StringBuilder(radiusmeshemitterdata, 1024);

SafeNativeMethods.mwle_fnRadiusMeshEmitterData_reload(sbradiusmeshemitterdata);
}
/// <summary>
/// Delete the emitter.)
/// 
...
internal void fnRadiusMeshEmitter_DeleteWhenEmpty (string radiusmeshemitter)
{
var sbradiusmeshemitter = new StringBuilder(radiusmeshemitter, 1024);

SafeNativeMethods.mwle_fnRadiusMeshEmitter_DeleteWhenEmpty(sbradiusmeshemitter);
}
/// <summary>
